...
public interface eGramListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterCasei(eGramParser.CaseiContext ctx);
	/**
	 * Exit a parse tree produced by {@link eGramParser#casei}.
	 * @param ctx the parse tree
	 */
	void exitCasei(eGramParser.CaseiContext ctx);
	/**
	 * Enter a parse tree produced by {@link eGramParser#endcase}.
	 * @param ctx the parse tree
	 */
	void enterEndcase(eGramParser.EndcaseContext ctx);
	/**
	 * Exit a parse tree produced by {@link eGramParser#endcase}.
	 * @param ctx the parse tree
	 */
	void exitEndcase(eGramParser.EndcaseContext ctx);
	/**
